        ...
        <form id="loginForm" class="auth-form" autocomplete="on">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    <svg viewBox="0 0 24 24" width="18" height="18">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="red" stroke-width="2" fill="none"/>
                        <polyline points="22,6 12,13 2,6" stroke="red" stroke-width="2" fill="none"/>
                    </svg>
                    <input 
                        type="email" 
                        id="loginEmail" 
            ...
            <div class="form-group">
                ...
                <div class="password-input">
                    <div class="input-icon">
                        <svg viewBox="0 0 24 24" width="18" height="18">
                            <rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke="green" stroke-width="2" fill="none"/>
                            <path d="M7 11V7a5 5 0 0 1 10 0v4" stroke="green" stroke-width="2" fill="none"/>
                        </svg>
                        <input 
                            type="password" 
                            id="loginPassword" 
                    ...
                    >
                        <svg class="eye-open" viewBox="0 0 24 24" width="20" height="20">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="green" stroke-width="2" fill="none"/>
                            <circle cx="12" cy="12" r="3" stroke="green" stroke-width="2" fill="none"/>
                        </svg>
                        <svg class="eye-closed" viewBox="0 0 24 24" width="20" height="20" style="display: none;">
                            <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" stroke="green" stroke-width="2" fill="none"/>
                            <line x1="1" y1="1" x2="23" y2="23" stroke="green" stroke-width="2"/>
                        </svg>
                    </button>
                </div>
            </div>
